...
const SupplyProductTypes = () => {
  ...
  const handleTypeClick = (typeId) => {
    navigate(`/supplying/products/${typeId}`);
  };

  const handleGoBack = () => {
    navigate('/supplying/give');
  };
  ...
  const sortedCategories = [...filteredCategories].sort((a, b) => {
    if (sortMode === 'usage') {
      return getCategoryUsage(b.id) - getCategoryUsage(a.id);
...
export default SupplyProductTypes;
